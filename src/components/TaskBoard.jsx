...
export function TaskBoard({theme, toggleTheme, tasks, dispatch}) {
  ...
  const visibleTasks = showCompleted
    ? tasks
    : tasks.filter((prev) => !prev.completed);
  ...
  return (
    <>
        ...
        >
          ...
          <Button label="Toggle theme" handleClick={toggleTheme}></Button>
          <Button
            ...
            visibleTasks?.map((element) => {
              return (
                <TaskCard
                  ...
                  onToggle={() =>
                    dispatch({ type: "TOGGLE_TASK", id: element.id })
                  }
                  onDelete={() =>
                    dispatch({ type: "DELETE_TASK", id: element.id })
                  }
                  status={taskStatus}
                ></TaskCard>
              );
